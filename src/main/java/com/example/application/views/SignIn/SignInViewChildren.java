...
public class SignInViewChildren extends Section {
    ...
    public SignInViewChildren(AuthService authService) {
        ...
        raceBox.setItems(Race.CURSA_COPII);
        raceBox.setValue(Race.CURSA_COPII);
