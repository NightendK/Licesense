package com.example.application.views.cursa21km;
...
public class Cursa21KmView extends VerticalLayout {
    ...
    private Image raceImage = new Image("images/Cursa21.png", "race");
    ...
    public Cursa21KmView() {
        ...
        date.setId("date");
        date.setText("Date : 25 september 2023");

        startTime.setId("startTime");
        startTime.setText("Start time : 10:30");

        distance.setId("distance");
        distance.setText("Distance : 21Km");

        limitTime.setId("limitTime");
        limitTime.setText("The race must be completed in maximum 4 hours. Candidates who complete the race in a time greater than 4 hours " +
        ...
        marathonDay.set(Calendar.DAY_OF_MONTH, 25);
